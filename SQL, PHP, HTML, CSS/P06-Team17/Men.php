...
Team 17 Project 6
Filename: Men.php
V1.0  09/14/20 AT Original
V1.1  09/15/20 AT Added Products
V1.2  10/28/20 AT changed for best practices
...
<body>
  ...
  <hr>
  <main>
    <h1 style="padding-right:15px; font-size:30px; font-family:sans-serif; text-align:center;">Men's Sneakers</h1>
    <div class="display-sneakers-rows">
      <div class="col-20">
        <h1>Filters</h1>
      </div>
      <div class="col-80">
