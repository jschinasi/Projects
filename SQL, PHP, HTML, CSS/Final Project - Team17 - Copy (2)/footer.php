...
*******************************************************************/
    ...
    echo "</p>";
    echo "<center>";
    echo "<a href=\"Changelog.php\">Version 2.1</a>&nbsp";
    ...
    echo "<small>";
    for ($len = 0; $len < sizeof(FILE_AUTHOR); $len += 1) {
        echo FILE_AUTHOR[$len] . "<br>";
    }
    echo "<br>&copy 2020 Steezy, Inc. All Rights Reserved";
    echo "<br>";
