      ...
      <center>
        <?php
          ...
          if ($_SERVER['REQUEST_METHOD'] == "POST" AND $error_message == "") {
            ...
            $q = "INSERT INTO T17_user (username, pass, hashtype, first_name, last_name, email_address, user_type, password_last_modified, active) " . 
            ...
            echo "<form action='Insert_User_Table.php' method='POST'>";
            echo "<fieldset>";
            ...
            echo "</select>";
            echo "<br> <input type='submit' value='Add User'>";
            echo "</fieldset>";
            echo "</form>";
